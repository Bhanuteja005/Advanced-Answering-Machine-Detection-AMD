                ...
                <AnimationContainer delay={0.1}>
                    <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                        ...
                        <p className="text-muted-foreground mt-4 text-sm text-start">
                            Advanced Answering Machine Detection powered by AI and Machine Learning.
                        </p>
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        <AnimationContainer delay={0.2}>
                            <div className="">
                                ...
                                <ul className="mt-4 text-sm text-muted-foreground">
                                    ...
                                    <li className="mt-2">
                                        <Link href="/dial" className="hover:text-foreground transition-all duration-300">
                                            Make a Call
                                        </Link>
                                    </li>
                                    <li className="mt-2">
                                        <Link href="/history" className="hover:text-foreground transition-all duration-300">
                                            Call History
                                        </Link>
                                    </li>
                                </ul>
                        ...
                        <AnimationContainer delay={0.3}>
                            <div className="mt-10 md:mt-0 flex flex-col">
                                ...
                                <ul className="mt-4 text-sm text-muted-foreground">
                                    <li className="">
                                        <Link href="/features/link-shortening" className="hover:text-foreground transition-all duration-300">
                                            Twilio Native
                                        </Link>
                                    </li>
                                    <li className="mt-2">
                                    ...
                                    <li className="mt-2">
                                        <Link href="/features/analytics" className="hover:text-foreground transition-all duration-300">
                                            HuggingFace ML
                                        </Link>
                                    </li>
                                    <li className="mt-2">
                                        <Link href="/features/qr-codes" className="hover:text-foreground transition-all duration-300">
                                            Gemini AI
                                        </Link>
                                    </li>
                                </ul>
            ...
            <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
                <AnimationContainer delay={0.6}>
                    <p className="text-sm text-muted-foreground mt-8 md:mt-0">
                        &copy; {new Date().getFullYear()} AMD System. All rights reserved.
                    </p>
                </AnimationContainer>
            </div>

            <div className="h-[20rem] lg:h-[20rem] hidden md:flex items-center justify-center">
                <TextHoverEffect text="AMD" />
            </div>
        </footer>
    )
}
