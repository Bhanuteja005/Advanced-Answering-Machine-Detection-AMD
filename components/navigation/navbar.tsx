...
const Navbar = () => {
    const user = null; // We're using Better Auth now
            ...
            <AnimationContainer reverse delay={0.1} className="size-full">
                <MaxWidthWrapper className="flex items-center justify-between">
                    <div className="flex items-center space-x-12">
                        <Link href="/#home">
                            <span className="text-lg font-bold font-heading !leading-none bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-clip-text text-transparent">
                                AMD System
                            </span>
                        </Link>
                                            ...
                                            <>
                                                ...
                                                <NavigationMenuContent>
                                                    <ul className={cn(
                                                        ...
                                                        link.title === "Strategies" ? "lg:grid-cols-[.75fr_1fr]" : "lg:grid-cols-2"
                                                    )}>
                                                        {link.title === "Strategies" && (
                                                                ...
                                                                <NavigationMenuLink asChild className="z-20 relative">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <p className="text-sm leading-tight text-muted-foreground">
                                                                            Choose from 4 AMD detection methods.
                                                                        </p>
                                                                    </Link>
                                                                </NavigationMenuLink>
                                                            </li>
                    ...
                    <div className="hidden lg:flex items-center">
                        {user ? (
                            <div className="flex items-center">
                                <Link href="/dial" className={buttonVariants({ size: "sm", })}>
                                    Dashboard
                                </Link>
                            </div>
                        ) : (
