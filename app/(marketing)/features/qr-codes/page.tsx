...
import { BrainCircuitIcon, ArrowRightIcon, SparklesIcon, ClockIcon, TrendingUpIcon } from "lucide-react";
            ...
            <MaxWidthWrapper>
                <div className="flex flex-col items-center justify-center w-full text-center py-12 md:py-20">
                    <AnimationContainer className="flex flex-col items-center justify-center w-full text-center">
                        <MagicBadge title="Google Gemini AI AMD" />
                        <h1 className="text-foreground text-center py-6 text-4xl font-medium tracking-normal text-balance sm:text-5xl md:text-6xl lg:text-7xl !leading-[1.15] w-full font-heading">
                            <span className="text-transparent bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-clip-text">Multimodal AI</span> Analysis
                        </h1>
                        <p className="mb-8 text-lg tracking-tight text-muted-foreground md:text-xl text-balance max-w-3xl">
                            Harness Google's Gemini AI for advanced multimodal audio analysis.
                            <br className="hidden md:block" />
                            Get comprehensive insights with 3-6 second processing time.
                        </p>
                            ...
                            <div className="rounded-md lg:rounded-xl bg-foreground/10 ring-1 ring-border p-8">
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4">
                                        <SparklesIcon className="w-8 h-8 text-violet-500 flex-shrink-0 mt-1" />
                                        <div className="text-left">
                                            <h3 className="text-xl font-bold mb-2">Multimodal Understanding</h3>
                                            <p className="text-muted-foreground">Advanced AI analyzes audio patterns, speech characteristics, and contextual cues.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        <BrainCircuitIcon className="w-8 h-8 text-green-500 flex-shrink-0 mt-1" />
                                        <div className="text-left">
                                            <h3 className="text-xl font-bold mb-2">Google AI Power</h3>
                                            <p className="text-muted-foreground">Leverage Google's cutting-edge Gemini models for state-of-the-art detection.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        <TrendingUpIcon className="w-8 h-8 text-fuchsia-500 flex-shrink-0 mt-1" />
                                        <div className="text-left">
                                            <h3 className="text-xl font-bold mb-2">Continuous Learning</h3>
                                            <p className="text-muted-foreground">Benefits from ongoing improvements to Gemini's capabilities and training.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <AnimationContainer delay={0.3} className="w-full max-w-5xl">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8">
                            <div className="p-6 rounded-xl border border-white/10 bg-card">
                                ...
                                <h3 className="text-xl font-bold mb-2">3-6 Seconds</h3>
                                <p className="text-muted-foreground text-sm">Processing Time</p>
                            </div>
                            <div className="p-6 rounded-xl border border-white/10 bg-card">
                                <SparklesIcon className="w-10 h-10 text-fuchsia-500 mb-4" />
                                <h3 className="text-xl font-bold mb-2">Multimodal</h3>
                                <p className="text-muted-foreground text-sm">AI Analysis</p>
                            </div>
                            <div className="p-6 rounded-xl border border-white/10 bg-card">
                                <BrainCircuitIcon className="w-10 h-10 text-blue-500 mb-4" />
                                <h3 className="text-xl font-bold mb-2">Google AI</h3>
                                <p className="text-muted-foreground text-sm">Gemini Models</p>
                            </div>
                        </div>
                    </AnimationContainer>
                    ...
                    <AnimationContainer delay={0.4} className="w-full max-w-4xl mt-12">
                        <div className="relative rounded-2xl border border-white/10 bg-gradient-to-b from-violet-500/10 to-fuchsia-500/10 p-12 text-center">
                            ...
                            <p className="text-lg text-muted-foreground mb-8">
                                Start using Google Gemini AI AMD in your calls today.
                            </p>
                            <Button asChild size="lg">
                                <Link href="/dial">
